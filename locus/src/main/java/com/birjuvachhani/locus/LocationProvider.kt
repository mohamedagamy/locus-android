 ...
 * @property mFusedLocationProviderClient (com.huawei.hms.location.FusedLocationProviderClient..com.huawei.hms.location.FusedLocationProviderClient?) used to request location
 * @constructor
 */
...
class EmptyCancellationToken : CancellationToken() {
    ...
    override fun register(p0: Runnable?): CancellationToken {
        return this
    }
}